        ...
        public override Object GetRecord(double longitude, double latitude, string table, string shapeField)
        {
            ...
            try
            {
                if ((latitude <= 90 && latitude >= -90) && (longitude <= 180 && longitude >= -180))
                {
                    ...
                    //ODO - Come back and try to make this work with a parameterized query - http://stackoverflow.com/questions/8355000/can-i-do-a-parameterized-query-containing-geometry-function
