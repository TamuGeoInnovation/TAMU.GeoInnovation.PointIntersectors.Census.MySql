...
{
    [Serializable]
    public class MySqlCensus2000StatesPointIntersector : AbstractCensus2000StatesPointIntersector
    {
        ...
        public MySqlCensus2000StatesPointIntersector()
            : base()
        { }

        public MySqlCensus2000StatesPointIntersector(double version, IQueryManager blockFilesQueryManager, IQueryManager stateFilesQueryManager, IQueryManager countryFilesQueryManager)
