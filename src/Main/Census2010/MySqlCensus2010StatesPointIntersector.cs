...
{
    [Serializable]
    public class MySqlCensus2010StatesPointIntersector : AbstractCensus2010StatesPointIntersector
    {
        ...
        public MySqlCensus2010StatesPointIntersector()
            : base()
        { }

        public MySqlCensus2010StatesPointIntersector(double version, IQueryManager blockFilesQueryManager, IQueryManager stateFilesQueryManager, IQueryManager countryFilesQueryManager)
