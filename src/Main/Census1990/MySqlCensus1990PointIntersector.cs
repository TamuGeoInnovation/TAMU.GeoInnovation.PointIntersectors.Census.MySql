...
namespace TAMU.GeoInnovation.PointIntersectors.Census.MySql.Census1990
{
    [Serializable]
    public class MySqlCensus1990PointIntersector : AbstractCensus1990PointIntersector
    {
        ...
        public MySqlCensus1990PointIntersector()
            : base()
        { }

        public MySqlCensus1990PointIntersector(double version, IQueryManager blockFilesQueryManager, IQueryManager stateFilesQueryManager, IQueryManager countryFilesQueryManager)
